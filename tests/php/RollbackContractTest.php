...
final class RollbackContractTest extends TestCase
{
	 ...
	 *
	 * Scenario:
	 *   Background: pfb_keep (#484 fix) and pfb_dnsbl_lenient use the lenient adapter (their
	 *     absent-default must be distinguishable from an explicit 'off').
	 *     Given the full registry.
	 *     When collecting all fields whose type is 'lenient'.
	 *     Then exactly those two appear.
	 */
