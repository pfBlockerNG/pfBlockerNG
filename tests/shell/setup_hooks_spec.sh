...
CODEGRAPH
  ...
  It 'initializes CodeGraph in the main checkout when the CLI is available'
    ...
    The contents of file "$install_log" should equal 'tool install --upgrade graphifyy[leiden] @ git+https://github.com/pfBlockerNG/graphify@3b841eedf531e99b8e3dbbac3fe9a5e8acb6a114'
