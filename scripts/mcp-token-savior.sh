...
# upstream token-savior-recall 4.19.0 with the MCP and vector-memory extras. A TS_SOURCE change
...
#   TS_SOURCE              pip requirement to install (default: upstream 4.19.0)
...
TS_SOURCE="${TS_SOURCE:-token-savior-recall[mcp,memory-vector]==4.19.0}"
