...
#   context — the only place it can affect the caller's git operations. The function
#   name is exported through spec_helper.sh as `scrub_git_env` for the test suite.
#
