...
without re-reading feed bytes or interpreting the manifest. The accepted body's
`tld_analysis()` coexistence text records the implementation at acceptance and is
