...
- **Status:** **Accepted** (2026-06-15; implemented 2026-06-05; authored 2026-06-02) — the TR39 analyzer + FP/TP corpus are green and the live matcher is exercised on the VM by `test_dnsbl_idn_confusable_blocks_homoglyph_resolves_legit` / `..._block_malicious_off_alerts_only`, green on **CE 2.8 + Plus 26.03** (fanout run 27547011086). (Originally Implemented — pending live smoke.)
- **Date:** 2026-06-02
