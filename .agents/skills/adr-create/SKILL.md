...
WEIGHT: light   <-- OPTIONAL (owner directive 2026-07-14). Only for a
 ...
 an EARLIER phase froze. /adr-phase then skips the fresh-context Reconcile
 stage (the planning stage's fixed cost): the implementer executes this prompt directly and
