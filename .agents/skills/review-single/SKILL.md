...
Use the small tier by default and for every delta review, the top tier for a
large/complex whole-PR review, and the mid tier only as the second half of
the documented top-tier fallback. `../../model-tiers.conf` resolves those tiers
