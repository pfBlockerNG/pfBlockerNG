...
- **Codex / Copilot:** native roles per `AGENTS.md` / `copilot-adapter.md`; same contract,
  floors, verdicts. Footer: `🤖 Generated by OpenAI Codex` / `🤖 Generated by GitHub
  Copilot`, each `and posted on behalf of @<login>.`
