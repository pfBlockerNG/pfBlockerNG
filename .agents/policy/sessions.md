...
worktree is the orchestration home, never the work-item worktree (see "Session layouts"
above). In an unfamiliar environment, probe at task start instead of assuming:
