export const meta = {
  ...
  whenToUse: 'ONLY on explicit user request for a multi-agent review — retired as pr-merge-flow\'s default (2026-07-11): the flow now runs the single-agent review-single workflow (latest Sonnet; the top-tier model — currently Fable — for a large/complex PR) at xhigh. Args: {pr: <number>, base: <branch>, worktree: <path>, spec: <intent/acceptance text>}.',
  phases: [
